...
var Albums = ["https://imgur.com/a/Q6bJZP1"];
            ...
            success: function(ajax) {
                ...
                ajax.data.forEach(function(curr) {
                    if(curr.description)
                    {
                        ...
                        var team_index = ObjectIndexOf(data[league_index].teams, "team", curr.description);
                        var jersey_type = parseInt(descriptor[2]);
                        var jersey = (jersey_type === 1)?'red':((jersey_type === 2)?'blue':'neutral');
                        if(team_index === -1)  // new team
                        {
                            data[league_index].teams.push({"team": curr.description, "jerseys": {}});
